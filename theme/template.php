...
<head>
<meta charset="utf-8">
<title>Kunal / <?php echo $title;?></title>
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. 98XXXXXXXXXX</p>
      ...
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          Guru Tegh Bahadur Institute of technology<br>
           Pin-110053 Delhi</address>
          <p>
            <i class="icon-phone"></i> 98XXXXXXXXX<br>
            <i class="icon-envelope-alt"></i> Kunalmishra13579@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; Kunal Mishra 2023 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
